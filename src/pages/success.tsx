    ...
    return (
        <>
            ...
            <SuccessContainer>
                ...
                <p>
                    Uhuul <strong>{costumerName}</strong>, sua compra de <strong>{product.imagesUrl.length}</strong> camiseta{product.imagesUrl.length > 1 ? 's': ''} já está a caminho da sua casa.
                </p>
